...
@section('content')
	...
	<div class="crumb_warp">
		...
		<i class="fa fa-home"></i> <a href="{{url('info')}}">首页</a> &raquo; 系统配置管理
	</div>
	<!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>程序-版本</label><span>小曾-1.0</span>
                </li>
                <li>
                ...
                <li>
                    <label>服务器域名/IP</label><span>{{$_SERVER['HTTP_REFERER']}}</span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://www.365cz.com</a></span>
                </li>
                <li>
