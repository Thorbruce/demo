                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <script id="editor" type="text/plain" name="art_content" style="width:800px;height:300px;"></script>
                            <p>标题可以写30个字</p>
                        </td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    ...
    $('#submit').click(function(){
        ...
        date={'cate_id':cate_id,'art_title':art_title,'art_editor':art_editor,'art_tag':art_tag,'art_content':art_content,'art_thumb':img,'art_description':art_description,'_token':'{{csrf_token()}}'};
